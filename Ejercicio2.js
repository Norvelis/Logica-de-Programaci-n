...
// para saber cual es mayor comparo uno con otro
// para sumar los valores de los indices (50 numeros)
// recorrer array con for
// 1. Array tipado como number[]
var array = [10, 25, 56, 128, 33, 12];
...
for (var i = 0; i < array.length; i++) {
    var num = array[i]; // Uso de 'const' para el valor actual y tipado
